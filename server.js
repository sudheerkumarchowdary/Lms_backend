  ...
  try {
    ...
    try {
      ...
      return res.status(500).json({ 
        message: 'Database connection failed. Please check your SQL database settings.',
    ...
    try {
      ...
      if (queryError.message.includes('Invalid object name') || queryError.message.includes('Users')) {
        return res.status(500).json({ 
          message: 'Users table not found. Please create the Users table in your database.',
